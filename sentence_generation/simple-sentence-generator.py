'''
good and accesible introductory activity for students learning python programming. The students are
provided with clear support for what a sentence is and how to convert an actual type of sentence into a function and then run it.
Useful starter code and comments. 
...
def complex_sentence():
  return random.choice(dependent_clause_markers) +" " + simple_sentence() + " "+ independent_clause()
